...
## How to get started!
To use this app, you need to have git bash. The logo should look something like this ![GitBash Logo](https://github.com/sjochen/liri-node-app/images/Screenshot(10).png).
