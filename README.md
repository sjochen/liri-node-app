...
## How to get started!
To use this app, you need to have git bash. The logo should look something like this [[https://github.com/sjochen/liri-node-app/blob/master/images/Screenshot(10).png|alt=octocat]].
